...
pub const FFI_DEFAULT_ABI: ffi_abi = ffi_abi::FFI_UNIX64;
#[derive(Copy, Clone)]
#[repr(u32)]
#[derive(Debug)]
pub enum ffi_abi {
...
impl ::std::default::Default for _ffi_type {
...
#[repr(u32)]
#[derive(Debug)]
pub enum ffi_status { FFI_OK = 0, FFI_BAD_TYPEDEF = 1, FFI_BAD_ABI = 2, }
...
impl ::std::default::Default for ffi_cif {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
#[repr(C)]
#[derive(Copy, Clone)]
...
impl ffi_raw {
    ...
    pub unsafe fn uint_(&mut self) -> *mut ffi_arg {
        let raw: *mut u8 = ::std::mem::transmute(&self._bindgen_data_);
        ::std::mem::transmute(raw.offset(0))
    }
...
impl ::std::default::Default for ffi_raw {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
...
impl ::std::default::Default for ffi_closure {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
#[repr(C)]
#[derive(Copy, Clone)]
...
impl ::std::default::Default for ffi_raw_closure {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
#[repr(C)]
#[derive(Copy, Clone)]
...
impl ::std::default::Default for ffi_java_raw_closure {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
#[derive(Copy, Clone)]
#[repr(u32)]
#[derive(Debug)]
pub enum ffi_type_enum { STRUCT = 13, COMPLEX = 15, }
extern "C" {
...
extern "C" {
    ...
    pub fn ffi_raw_call(cif: *mut ffi_cif,
                        fn_: ::std::option::Option<extern "C" fn()>,
